...
%  Notes -> \lambda | silencio (figure MaybeDot); Notes | nota (note MaybeNoteModifier, number, figure MaybeDot); Notes | nota (note MaybeNoteModifier, const_name, figure MaybeDot); Notes
%  MaybeDot -> \lambda | .
